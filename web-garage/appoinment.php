<?php
	...
	if(isset($_GET['aid']))
	{
        ...
        $q="update `appoinment_tbl` set status='1',approve_by_garage='$garagename' WHERE id=".$aid;
	...
	if(isset($_GET['cid']))
	{
        ...
        $q="update `appoinment_tbl` set status='0',approve_by_garage='' WHERE id=".$cid;
	...
	if(isset($_GET['comid']))
	{
        ...
        $q="update `appoinment_tbl` set status='2',approve_by_garage='$garagename' WHERE id=".$comid;
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Appoinment Service</h4>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-9">
								...
								<h3 align="center">New Appoinment Services</h3>
                                    <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $detail=mysqli_query($conn,"select * from  appoinment_tbl where status='0' and area='$area'");
                                            ...
                                            <tr>
												...
												<td><?php echo "<a class='btn1'href=appoinment.php?aid=".$row['id'].">Approve</a>"; ?>
									...
									<div class="table-responsive table--no-card m-b-30" style="height: auto; width: 1000px;">
									<h3 align="center">Your Approve appoinment services</h3>
									                                    <table class="table table-borderless table-striped table-earning" >
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $detail=mysqli_query($conn,"select * from  appoinment_tbl where status='1' and approve_by_garage='$garagename'");
                                                while($row=mysqli_fetch_array($detail)){
                                            ?>
                                            <tr>
                                               <td ><?php echo $row['id']; ?></td>
												...
												<td><?php echo "<a class='btn1'href=appoinment.php?cid=".$row['id'].">Cancel Appoinment</a>"; ?>
												<td><?php echo "<a class='btn1'href=appoinment.php?comid=".$row['id'].">Complete Appoinment</a>"; ?>
									...
									<br><br>
									<div class="table-responsive table--no-card m-b-30" style="height: auto; width: 1000px;">
									<h3 align="center">Your Complete appoinments services</h3>
									                                    <table class="table table-borderless table-striped table-earning" >
                                        <thead>
                                            <tr>
                                                <th>id</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $detail=mysqli_query($conn,"select * from  appoinment_tbl where status='2' and approve_by_garage='$garagename'");
                                                while($row=mysqli_fetch_array($detail)){
                                            ?>
                                            <tr>
                                               <td ><?php echo $row['id']; ?></td>

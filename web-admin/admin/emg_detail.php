...
{
	extract($_GET);
	$q="delete from emergency_service where id='$did'";
	mysqli_query($conn,$q);
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
           <div class="header-search-wrapper hide-on-med-and-down">
             <h5 Style="color:white;">Emergency services</h5>
            </div>
    ...
    <div id="main">
      ...
      <div class="card subscriber-list-card animate fadeRight">
         <div class="card-content pb-1">
            <h4 class="card-title mb-0">Emergency services List </h4>
         </div>
		...
		<div class="scrollit">
         <table class="subscription-table responsive-table highlight">
            <thead>
               <tr>
                  ...
                  <th>Address</th>
                  <th>Message</th>
                  <th>Approve by garage</th>
                  <th>Action</th>
               </tr>
            </thead>
            <tbody>
			 <?php
			$q="select * from emergency_service";
		 ...
		 ?>
               <tr>
                                                ...
                                                <td ><?php echo $row['approve_by_garage']; ?></td>
												
												<td><?php echo "<a style='color:red;border: 2px solid red;padding: 5px;border-radius: 5px; 'href=emg_detail.php?did=".$row['id'].">Delete</a>"; ?>

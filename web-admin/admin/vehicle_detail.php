...
{
	extract($_GET);
	$q="delete from vehicle_detail	 where id='$did'";
	mysqli_query($conn,$q);
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
           <div class="header-search-wrapper hide-on-med-and-down">
             <h5 Style="color:white;">Vehicel Detail</h5>
            </div>
    ...
    <div id="main">
      ...
      <div class="card subscriber-list-card animate fadeRight">
         <div class="card-content pb-1">
            <h4 class="card-title mb-0">Old Vehicel List </h4>
         </div>
		 <div class="scrollit">
		 ...
		 ?>
               <tr>
												...
												<td><?php echo "<img src="."../".$row['vehicle_image']." alt=image height=80px width=80px style=border-radius:50%; >"; ?></td>
												<td><?php echo "<a style='color:red;border: 2px solid red;padding: 5px;border-radius: 5px; 'href=vehicle_detail.php?did=".$row['id'].">Delete</a>"; ?>

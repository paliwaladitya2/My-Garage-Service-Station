...
{
	extract($_GET);
	$q="delete from appoinment_tbl where id='$did'";
	mysqli_query($conn,$q);
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
           <div class="header-search-wrapper hide-on-med-and-down">
             <h5 Style="color:white;">Appoinment Detail</h5>
            </div>
    ...
    <div id="main">
      ...
      <div class="card subscriber-list-card animate fadeRight">
         <div class="card-content pb-1">
            <h4 class="card-title mb-0">Appoinment List </h4>
         </div>
		 <div class="scrollit">
		 ...
		 ?>
               <tr>
												...
												<td><?php echo "<a style='color:red;border: 2px solid red;padding: 5px;border-radius: 5px; 'href=appoinment.php?did=".$row['id'].">Delete</a>"; ?>

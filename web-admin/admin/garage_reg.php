...
{
	extract($_GET);
	$q="delete from register_tbl where id='$did'";
	mysqli_query($conn,$q);
...
{
	extract($_GET);
	 $q="update `register_tbl` set status='1' WHERE id=".$aid;
	mysqli_query($conn,$q);
			// $to = $email;
			// $txt = "your Register  Garage will be contact to soon Thank you to work with My Garage Service Station...";
...
{
	extract($_GET);
	 $q="update `register_tbl` set status='0' WHERE id=".$Daid;
	mysqli_query($conn,$q);
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
           <div class="header-search-wrapper hide-on-med-and-down">
             <h5 Style="color:white;">Garage User Detail</h5>
            </div>
    ...
    <div id="main">
      ...
      <div class="card subscriber-list-card animate fadeRight">
         <div class="card-content pb-1">
            <h4 class="card-title mb-0">Register List </h4>
         </div>
		 ...
		 ?>
               <tr>
                                                ...
                                                <td ><?php echo $row['area']; ?></td>
												 <td><?php echo "<img src="."../".$row['owner_photo']." alt=image height=80px width=80px style=border-radius:50%; >"; ?></td>
												  <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['status']; ?></td>
												 
												<td>
												<?php echo "<a style='color:green;    border: 2px solid green;
    padding: 5px;
    border-radius: 5px;'href=garage_reg.php?aid=".$row['id'].">Approve</a>"; ?>
												
												</td>
												<td>
												<?php echo "<a style='color:#ffb366;    border: 2px solid #ffb366;
    padding: 5px;
    border-radius: 5px;'href=garage_reg.php?Daid=".$row['id'].">Disapprove</a>"; ?>
												
												</td>
												<td><?php echo "<a style='color:red;    border: 2px solid red;
    padding: 5px;
    border-radius: 5px; 'href=garage_reg.php?did=".$row['id'].">Delete</a>"; ?>
												</td>

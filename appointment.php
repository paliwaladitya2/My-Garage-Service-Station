...
{extract($_POST);
	$cap=$_SESSION['cap_code'];
		...
		mysqli_query($conn,"INSERT INTO `appoinment_tbl`( `model`, `service`, `date`, `time`, `name`, `email`, `phone`, `area`, `veh_type`, `msg`) VALUES ('$model','$service','$date','$time','$name','$email','$phone','$area','$type','$msg')");
		echo mysqli_error($conn);
		$data="Thank you for Informing US.";
			$to = $email;
			$txt = "Your Appointment Will Be Send To All Garage Station Nearby Your Area, Garage Owner Will Be Contact To You Soon,Thank You For Working With Us...";
...
.tushu{
	...
	<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2>Appointment</h2>
                                <span><a href="index.html">home</a> / Appointment</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form  method="post"  action="" class="appointment-form" >
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="model" id="Year" class="demo" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="service" id="selectServices" class="demo">
                                        <option value="NULL">-- Select Service --</option>
                                        <option value="Aluminum Repair">Aluminum Repair</option>
                                        <option value="Fender Repair">Fender Repair</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="time" id="Time" class="demo">
      ...
      <footer class="site-footer">
        ...
        </footer> <!-- End Footer Area --><!-- End Footer Area -->

                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <div class="main-menu-two">
                            <ul class="nav navbar-nav navbar-right">
								...
								<li><a href="contact-us-dark.html">about</a></li>
...
{
		extract($_GET);
						$q="select * from vehicle_detail where  id=".$id;
...
?>
				...
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
								...
								//echo $path;	
								?>
									<img src="<?php echo $path; ?>"  alt=""  data-imagezoom="true" class="img-responsive" alt=""> </div>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<p>
					<span class="item_price" style=" color:red;">Rs.<?php echo $row['price'];?></span>
					<del></del>
				...
				<div class="single-infoagile">
					...
					<li>	<i class="fa fa-hand-o-right" aria-hidden="true"></i>Garage Detail</p>
								Garage Name:<?php echo $row['garage_name'];?><br>
								Garage phone:<?php echo $row['garage_phone'];?><br>
								Garage Address:<?php echo $row['garage_add'];?><br>
